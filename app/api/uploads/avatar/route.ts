...
import { PhotoTooLargeError } from "@/modules/photo-upload/Errors/PhotoTooLargeError";
import { UnreadablePhotoError } from "@/modules/photo-upload/Errors/UnreadablePhotoError";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    if (e instanceof PhotoTooLargeError || e instanceof UnreadablePhotoError) {
